...
/**
 * base on https://github.com/strimzi/strimzi-kafka-operator/blob/master/operator-common/src/main/java/io/strimzi/operator/common/model/Labels.java
 */
public class Labels {
     ...
     */
    public static Labels generateDefaultLabels(String instanceName, String kind, String component,
                                               String applicationName, String managedBy) {
        return Labels.EMPTY
                .withStrimziKind(kind)
                .withStrimziName(applicationName)
